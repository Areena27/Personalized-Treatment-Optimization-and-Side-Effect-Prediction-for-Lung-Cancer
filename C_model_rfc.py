...
def train_all_models(features, treatment_labels, drug_labels, side_effects_labels):
    ...
    treatment_model = train_model(X_train, X_val, y_train_treatment, y_val_treatment, " C_rfc_treatment", param_dist)
    
    # Train drug model
    drug_model = train_model(X_train, X_val, y_train_drug, y_val_drug, "C_rfc_drug", param_dist)
    ...
    side_effects_model = train_model(
        ...
        "C_rfc_side_effects", param_dist, is_multi_output=True
    )
